...
import { Calendar, Clock, CheckCircle, Star, ArrowRight, BookmarkPlus, ChevronDown, Sparkles } from 'lucide-react';
...
const WEBINAR_JOIN_URL = ''; // Optional Zoom/Webinar join URL — leave '' for "we'll email it to you"
  ...
  if (registered) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-orange-50/60 via-white to-white text-gray-900">
        <div className="max-w-2xl mx-auto px-5 pt-16 md:pt-24 pb-20">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-snug mb-10">
          ...
          <div className="bg-white border-2 border-orange-200 rounded-2xl p-6 md:p-7 shadow-sm mb-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-900 font-bold">{formatHumanTime(start)}</p>
            </div>
          </div>
          ...
          {/* Bookmark */}
          <div className="bg-gray-50 border border-gray-200 rounded-xl px-5 py-4 mb-8 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                Press <span className="font-mono font-bold text-gray-900">Ctrl/Cmd + D</span> to bookmark this page so you can come back when it's time. We'll also email the join link about an hour before the training starts.
              </p>
            </div>
          </div>
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl px-5 py-4">
            <p className="text-orange-700 text-xs font-bold uppercase tracking-wider mb-2">
              Show up ready
            </p>
            <ul className="space-y-1.5 text-sm text-gray-800 leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                Use a desktop or laptop if you can — easier to follow along
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-orange-600 shrink-0 mt-0.5" />
                Have a notepad ready — Travis moves fast
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-orange-600 shrink-0 mt-0.5" />
                Block the time on your calendar so nothing gets in the way
              </li>
            </ul>
          </div>
        </div>
